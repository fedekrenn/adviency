...
const DuplicateModal = ({
  ...
  useEffect(() => {
    ...
    setGiftPrice((giftToEdit.totalPrice / giftToEdit.quantity).toFixed(2));
  ...
  return (
    <Dialog open={openDuplicate} onClose={handleClose}>
      ...
      <DialogContent>
        <form className="add-product-form">
          ...
          <TextField
            ...
            type="url"
            label="Url de imagen"
            onChange={(e) => setGiftThumbnail(e.target.value)}
            variant="standard"
            required
          />
          <TextField
      ...
      <DialogActions>
        <Button color="error" variant="text" onClick={addGift}>
          Duplicar
        </Button>
