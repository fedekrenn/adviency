    ...
    <Dialog open={openEdit} onClose={handleClose}>
      ...
      <DialogContent>
        <form className="add-product-form">
          ...
          />
          <TextField
            value={changedThumbnail}
            type="url"
            label="Url de imagen"
            onChange={(e) => setChangedThumbnail(e.target.value)}
            variant="standard"
            required
          />
          <TextField
          ...
          />
          <TextField
            value={changedGiftReceiver}
            label="Para quien es?"
            onChange={(e) => setChangedGiftReceiver(e.target.value)}
            variant="standard"
            required
          />
        </form>
      ...
      <DialogActions>
        <Button color="error" variant="text" onClick={handleEditGift}>
          Aplicar cambios
        </Button>
